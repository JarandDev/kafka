...
docker run -dt --name broker \
  ...
  -e KAFKA_ADVERTISED_LISTENERS=PLAINTEXT://broker:29091,PLAINTEXT_HOST://192.168.0.245:9091 \
  ...
  -e KAFKA_CONTROLLER_QUORUM_VOTERS=1@192.168.0.243:29081,2@192.168.0.244:29081,3@broker:29081 \
