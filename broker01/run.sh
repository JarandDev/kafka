...
cp -r /home/pi/kafka/storage-backup/broker01 /home/pi/kafka-storage/storage-broker
...
docker run -dt --name broker \
  ...
  -e KAFKA_ADVERTISED_LISTENERS=PLAINTEXT://broker:29091,PLAINTEXT_HOST://192.168.0.247:9091 \
  ...
  -e KAFKA_CONTROLLER_QUORUM_VOTERS=1@broker:29081,2@192.168.0.248:29081,3@192.168.0.249:29081 \
